...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <PageHeader
                title="Events"
                subtitle="Browse and participate in events"
                :crumbs="[
                                ...
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-2 text-sm text-gray-500">
                                            ...
                                            <span v-if="event.lock_date" class="ml-4">
                                                Lock Date: {{ new Date(event.lock_date).toLocaleDateString() }}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ml-4 flex space-x-2">
                                        ...
                                        <Link
                                            v-if="$page.props.auth.user.role === 'admin' || $page.props.auth.user.id === event.created_by"
