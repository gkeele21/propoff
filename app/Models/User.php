...
class User extends Authenticatable
{
    ...
    {
        // User must own the entry OR it was submitted by a captain and user wants to edit
        if ($this->id !== $entry->user_id) {
            return false;
        }

        // Cannot edit if group is no longer accepting entries
        ...
        // User can edit even if it was submitted by captain (per requirements)
        return true;
    }
