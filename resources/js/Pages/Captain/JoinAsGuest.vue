        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="flex justify-center">
                <div class="bg-warning/10 rounded-full p-3">
                    <UserGroupIcon class="h-12 w-12 text-warning" />
                </div>
            </div>
            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <div class="space-y-6">
                    ...
                    <div class="bg-primary/10 border border-primary/30 rounded-lg p-4">
                        ...
                        <p v-if="event.description" class="text-sm text-primary mt-2">
                            {{ event.description }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-gray-600">
                            <li class="flex items-start">
                                <CheckCircleIcon class="h-5 w-5 text-success mr-2 flex-shrink-0 mt-0.5" />
