...
class UserController extends Controller
{
    ...
    {
        $query = User::withCount(['entries', 'groups']);
    ...
    public function statistics()
    {
        $stats = [
            ...
            'active_users' => User::whereHas('entries', function ($query) {
        ...
        // Top participants
        $topParticipants = User::withCount('entries')
